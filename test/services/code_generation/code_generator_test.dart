...
class I18nDelegate extends LocalizationsDelegate<I18n> {
  ...
  static final Set<Locale> supportedLocals = {Locale('en', 'US'), Locale('de')};
...
class I18n {
  ...
  static String test({required String name}) =>
      _getText('test').replaceAll('%name\\\$s', name);

  static late Map<String, String> _localizedValues;

  static const _enUSValues = {'test': 'Hello %name\\\$s!'};

  static const _deValues = {'test': 'Hallo %name\\\$s!'};

  static const _allValues = {'en_US': _enUSValues, 'de': _deValues};
...
/// A class generated by flappy_translator package containing localized strings
class I18n {
  static String test({required String var1}) =>
      _getText('test').replaceAll('%1\\\$s', var1);

  static late Map<String, String> _localizedValues;

  static const _enValues = {'test': 'Hello %1\\\$s!'};

  static const _allValues = {'en': _enValues};
...
/// A class generated by flappy_translator package containing localized strings
class I18n {
  static String test({required String varfor}) =>
      _getText('test').replaceAll('%for\\\$s', varfor);

  static late Map<String, String> _localizedValues;

  static const _enValues = {'test': 'Hello %for\\\$s!'};
...
/// A class generated by flappy_translator package containing localized strings
class I18n {
  static String test({required String varint}) =>
      _getText('test').replaceAll('%int\\\$s', varint);

  static late Map<String, String> _localizedValues;

  static const _enValues = {'test': 'Hello %int\\\$s!'};
...
class I18n {
  ...
  static const _enValues = {"test": "Hello"};

  static const _deValues = {"test": "Hello in german"};

  static const _esValues = {"test": "Hello in spanish"};

  static const _allValues = {"en": _enValues, "de": _deValues, "es": _esValues};
